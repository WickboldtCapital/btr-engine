...
units = st.sidebar.number_input("Number of Units (Doors)", min_value=1, value=1, step=1)
...
land_basis = st.sidebar.number_input("Land Basis per Lot ($)", value=15000, step=1000)
soft_costs = st.sidebar.number_input("Soft Costs per Unit ($)", value=5500, step=500)
const_fees = st.sidebar.number_input("Const. Loan Closing Fee per Unit ($)", value=6000, step=500)
